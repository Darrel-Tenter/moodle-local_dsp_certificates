 ...
 * reporting tool that queries existing Moodle Workplace tables
 * (tool_certificate_issues, tool_certificate_templates, tool_tenant_user, user).
 * All personal data displayed by this plugin is owned and managed by the
 * subsystems that store it.
 *
 ...
 *  - It reads only from core Moodle and Moodle Workplace tables whose
 *    privacy is managed by those subsystems.
